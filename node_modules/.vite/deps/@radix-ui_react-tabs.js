...
var DirectionProvider = __name9((props) => {
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React10.useState(_isHydrated);
  React10.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
__name10(useIsHydratedModern, "useIsHydratedModern");
...
var RovingFocusGroup = React11.forwardRef(
  ...
  __name11(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React11.forwardRef(__name11(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React11.forwardRef(
  // blank line to reduce diff noise
  __name11(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
__name11(getDirectionAwareKey, "getDirectionAwareKey");
...
__name11(getFocusIntent, "getFocusIntent");
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name12((event) => {
      ...
      const handleAnimationStart = __name12((event) => {
...
var Tabs = React13.forwardRef(
  // blank line to reduce diff noise
  __name13(function Tabs2(props, forwardedRef) {
    const {
      __scopeTabs,
      value: valueProp,
      onValueChange,
...
var TabsList = React13.forwardRef(
  // blank line to reduce diff noise
  __name13(function TabsList2(props, forwardedRef) {
...
var TabsTrigger = React13.forwardRef(
  __name13(function TabsTrigger2(props, forwardedRef) {
...
var TabsContent = React13.forwardRef(
  __name13(function TabsContent2(props, forwardedRef) {
...
__name13(makeTriggerId, "makeTriggerId");
function makeContentId(baseId, value) {
  return `${baseId}-content-${value}`;
}
__name13(makeContentId, "makeContentId");
var Root2 = Tabs;
var List = TabsList;
