import { A as ACTIVITY_LEVELS } from "./storage-CZEK3EWH.mjs";
import { i as isSameLocalDay } from "./date-Cpa6Svv0.mjs";
function calcMealFromFood(food, gramas) {
